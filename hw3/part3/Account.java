...
public class Account
{
    ...
    private LDLinkedList<String> followers = new LDLinkedList<String>();
    /**
     ...
     */
    private LDLinkedList<String> BlockedBy;
    /**
     * part3 is done here
    ...
    public Account(int id, String nick,String date,String city)
    {
        ...
        BlockedBy = new LDLinkedList<String>();
    ...
    {
        Iterator<String> temp_iterator = following.iterator();
    ...
    {
        Iterator<String> temp_iterator = followers.iterator();
        if(obj.is_login==true)
        {
    ...
    {
        Iterator<Post> temp_iterator = obj.posts.iterator();
        if(is_login ==true && this.check_banned(obj)==false)
        {
    ...
    */
     ...
     * @throws ArrayIndexOutOfBoundsException it checks boundry of the linkedlist.
     */
