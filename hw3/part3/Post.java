...
public class Post
{
     ...
     */
    private LDLinkedList<String> likes;
    /**
     * it containts comments on a post
     */
    private LDLinkedList<String> comments;
    /**
     * who did a comment on a post.
     */
    private LDLinkedList<String> WhoComments;
    /**
    ...
    public Post(int id,int ac_id,String temp_like,String temp_comment, String temp_content)
    {
        ...
        comments = new LDLinkedList<String>();
        likes = new LDLinkedList<String>();
        WhoComments = new LDLinkedList<String>();
    }
    /**
    ...
    public void see_likes()
    {
        ...
        if(likes.size() >0)
            System.out.println("Post was liked by "+likes.size());
    ...
    {
        Iterator<String> temp_iter = comments.iterator();
        Iterator<String> temp_two = WhoComments.iterator();
